...
public class FireExtinguisher : MonoBehaviour
{
    ...
    private OVRGrabbable fireExtinguisherGrabbable;
    // Start is called before the first frame update
    void Start()
    {
        fireExtinguisherGrabbable = fireExtinguisher.GetComponent<OVRGrabbable>();
    ...
    void Update()
    {
        ...
        if (fireExtinguisherGrabbable != null && fireExtinguisherGrabbable.isGrabbed)
        {
        ...
        {
            audio.Stop();
            OVRGrabbable fireExtinguisherGrabbable = fireExtinguisher.GetComponent<OVRGrabbable>();
            if (fireExtinguisherGrabbable != null && fireExtinguisherGrabbable.grabbedBy != null && fireExtinguisherGrabbable.grabbedBy.m_controller != null)
            {
                OVRInput.SetControllerVibration(0f, 0f, fireExtinguisherGrabbable.grabbedBy.m_controller);
            }
            foamEffect.Stop();
        }
