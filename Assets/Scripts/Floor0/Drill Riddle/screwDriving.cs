...
public class screwDriving : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            audio.Stop();
            OVRGrabbable drillGrabbable = Drill.GetComponent<OVRGrabbable>();
            if (drillGrabbable != null && drillGrabbable.grabbedBy != null && drillGrabbable.grabbedBy.m_controller != null)
            {
                OVRInput.SetControllerVibration(0.0f, 0.0f, drillGrabbable.grabbedBy.m_controller);
            }
